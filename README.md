...
Open the planner: https://poosquad82.github.io/monthly-planner/
...
2. Double-click `update-site.bat` (or Commit + Push in GitHub Desktop). The site refreshes in about a minute.

## One-time setup (if the repo doesn't exist yet)
1. Create a **public** repo named `monthly-planner` at github.com/poosquad82.
